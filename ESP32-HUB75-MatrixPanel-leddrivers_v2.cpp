...
void MatrixPanel_I2S_DMA::icn2053setReg(uint8_t reg_idx, driver_rgb_t* regs_data)
{
...
void MatrixPanel_I2S_DMA::icn2053initBuffers()
{
...
void MatrixPanel_I2S_DMA::shiftDriverInit()
{
  switch (m_cfg.driver)
  {
    case MBI5124:
